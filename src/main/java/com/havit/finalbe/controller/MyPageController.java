...
public class MyPageController {
    ...
    @PostMapping("/check")
    public ResponseDto<?> checkPassword(@RequestBody MemberDto.CheckPassword checkPasswordDto,
    ...
    public ResponseDto<?> editMyInfo(@ModelAttribute MemberDto.MyPage myPageDto,
    ...
    @PutMapping("/image")
    public ResponseDto<?> deleteProfile(@AuthenticationPrincipal UserDetailsImpl userDetails) {
