...
public class ParticipateController {
    ...
    @PostMapping("/{groupId}")
    public ResponseDto<GroupDto.Response> participate(@PathVariable Long groupId, @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    public ResponseDto<GroupDto.Response> cancelParticipation(@PathVariable Long groupId, @AuthenticationPrincipal UserDetailsImpl userDetails) {
